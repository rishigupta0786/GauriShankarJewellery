...
import { X, ChevronLeft, ChevronRight, Diamond, Scale, Hash, Tag, Sparkles, Weight } from "lucide-react";
  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          className="absolute inset-0 bg-linear-to-br from-gray-800/95 via-black/90 to-gray-800 backdrop-blur-xl"
          onClick={onClose}
        />
        ...
        <motion.div
          ...
          animate="visible"
          exit="exit"
          className="relative z-10 w-full max-w-6xl h-[90vh] sm:h-[70vh] md:h-[80vh] flex flex-col md:flex-row bg-gray-950 rounded-2xl md:rounded-3xl overflow-hidden border border-white/10 shadow-2xl"
        >
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.9 }}
            onClick={onClose}
            className="absolute top-3 right-3 sm:top-4 sm:right-4 p-2 bg-white/5 hover:bg-white/10 backdrop-blur-sm text-white rounded-full transition-all duration-300 z-30"
          >
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1 relative bg-linear-to-br from-gray-900/30 via-gray-800/20 to-gray-900/30 backdrop-blur-sm">
                ...
                <motion.button
                  ...
                  className="absolute left-2 sm:left-4 top-1/2 -translate-y-1/2 p-2 sm:p-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white rounded-full transition-all duration-300 z-10"
                >
                ...
                <motion.button
                  ...
                  className="absolute right-2 sm:right-4 top-1/2 -translate-y-1/2 p-2 sm:p-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white rounded-full transition-all duration-300 z-10"
                >
              ...
              <div className="bg-linear-to-b from-gray-900/40 via-gray-800/30 to-gray-900/40 backdrop-blur-sm border-t border-white/10 p-4 overflow-y-auto max-h-[45%]">
                ...
                <div className="mb-4">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h2 className="text-lg font-light text-white">Product Details</h2>
                  </div>
                ...
                {/* Design Name */}
                <div className="mb-4">
                  <h3 className="text-xl font-serif text-amber-100 mb-2">{designName}</h3>
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-amber-500/20">
                    ...
                    <span className="text-xs text-amber-200 font-medium">{purity} Gold</span>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all duration-300 border border-white/5">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          <div className="text-xs text-gray-400">Article Code</div>
                          <div className="text-sm font-medium text-white">{articleCode}</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all duration-300 border border-white/5">
                      <div className="flex items-center gap-2.5">
                        <div className="p-1.5 bg-white/10 rounded">
                          <Weight className="w-2.5 h-2.5 text-amber-300" />
                        </div>
                        <div>
                          <div className="text-xs text-gray-400">Gross Weight</div>
                          <div className="text-base font-bold text-amber-300">{grossWeight}g</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-white/5 backdrop-blur-sm rounded-lg p-3 hover:bg-white/10 transition-all duration-300 border border-white/5">
                      <div className="flex items-center gap-2.5">
                        <div className="p-1.5 bg-white/10 rounded">
                          <Scale className="w-2.5 h-2.5 text-amber-300" />
                        </div>
                        <div>
                          <div className="text-xs text-gray-400">Net Weight</div>
                          <div className="text-base font-bold text-amber-300">{netWeight}g</div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-linear-to-br from-amber-900/20 to-transparent rounded-lg p-3 border border-amber-500/20 backdrop-blur-sm">
                      <div className="flex items-center gap-2.5">
                        ...
                        <div>
                          ...
                          <div className="text-sm font-medium text-amber-200">{purity} Gold</div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <>
              ...
              <div className="flex-1 relative bg-linear-to-br from-gray-900/30 via-gray-800/20 to-gray-900/30 backdrop-blur-sm">
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={() => setCurrent(current > 0 ? current - 1 : images.length - 1)}
                  className="absolute left-4 top-1/2 -translate-y-1/2 p-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white rounded-full transition-all duration-300 z-10"
                >
                ...
                <motion.button
                  ...
                  whileTap={{ scale: 0.9 }}
                  onClick={() => setCurrent(current < images.length - 1 ? current + 1 : 0)}
                  className="absolute right-4 top-1/2 -translate-y-1/2 p-3 bg-white/10 hover:bg-white/20 backdrop-blur-sm text-white rounded-full transition-all duration-300 z-10"
                >
              ...
              <div className="w-96 flex flex-col bg-linear-to-b from-gray-900/40 via-gray-800/30 to-gray-900/40 backdrop-blur-sm border-l border-white/10 p-6 overflow-y-auto">
                ...
                <div className="mb-5">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h2 className="text-xl font-light text-white">Product Details</h2>
                  </div>
                  <div className="h-px bg-linear-to-r from-amber-500/30 via-amber-300/50 to-transparent" />
                </div>
                ...
                {/* Design Name */}
                <div className="mb-5">
                  <h3 className="text-2xl font-serif text-amber-100 mb-2">{designName}</h3>
                  <div className="inline-flex items-center gap-1.5 px-2.5 py-1 bg-white/10 backdrop-blur-sm rounded-full border border-amber-500/20">
                    <Sparkles className="w-3 h-3 text-amber-300" />
                    <span className="text-sm text-amber-200 font-medium">{purity} Gold</span>
                  </div>
                </div>
                ...
                <div className="space-y-4 flex-1">
                  ...
                  {/* Material Info */}
                  <div className="bg-linear-to-br from-amber-900/20 to-transparent rounded-lg p-3 border border-amber-500/20 backdrop-blur-sm">
                    <h4 className="text-sm font-medium text-white mb-1.5">Material Quality</h4>
                    <div className="flex items-center gap-2.5">
                      <div className="p-2 bg-amber-900/30 rounded">
                        <Diamond className="w-4.5 h-4.5 text-amber-300" />
                      </div>
                      <div>
                        <div className="text-xs text-gray-300">Premium {purity} Gold</div>
                        <div className="text-xs text-gray-400 mt-0.5">Finest craftsmanship with certified purity</div>
                      </div>
                    </div>
                  </div>
                </div>
